...
sonic_hitbox_Y_by_anim:
		...
		.BYTE	24   ; 02 | $02 |  walk1
		.BYTE	24   ; 03 | $03 |  walk2
		.BYTE	24   ; 04 | $04 |  walk3 (run)
		.BYTE	24   ; 05 | $05 |  walk4 (run)
		.BYTE	24   ; 06 | $06 |  spring_jump
		.BYTE	24   ; 07 | $07 |  skid

		.BYTE	24-4 ; 08 | $08 |  spin_jump
		.BYTE	24   ; 09 | $09 |  death
		.BYTE	24   ; 10 | $0A |  get_hit
		.BYTE	24-4 ; 11 | $0B |  sit
		.BYTE	24   ; 12 | $0C |  look_up
		.BYTE	24   ; 13 | $0D | _push
		.BYTE	24   ; 14 | $0E | _wait0
		.BYTE	24   ; 15 | $0F | _wait1

		.BYTE	24   ; 16 | $10 | _wait3
		.BYTE	24   ; 17 | $11 |  drown
		.BYTE	24   ; 18 | $12 | _turn_super_1
		.BYTE	24   ; 19 | $13 | _turn_super_2
		.BYTE	24   ; 20 | $14 | _idle (?)
		.BYTE	24   ; 21 | $15 | _walk_90_x1
		.BYTE	24   ; 22 | $16 | _walk_90_x2
		.BYTE	24   ; 23 | $17 | _walk_90_x2

		.BYTE	24   ; 24 | $18 | __run_90_x1
		.BYTE	24   ; 25 | $19 | __run_90_x2
		.BYTE	24   ; 26 | $1A | _walk_45_x1
		.BYTE	24   ; 27 | $1B | _walk_45_x2
		.BYTE	24   ; 28 | $1C | _walk_45_x2
		.BYTE	24   ; 29 | $1D | __run_45_x1
		.BYTE	24   ; 30 | $1E | __run_45_x2
		.BYTE	24-4 ; 31 | $1F |  start spindash

		.BYTE	24-4 ; 32 | $20 |  spin (no jump)
		.BYTE	24   ; 33 | $21 | _walk_135_x1
		.BYTE	24   ; 34 | $22 | _walk_135_x2
		.BYTE	24   ; 35 | $23 | _walk_135_x2
		.BYTE	24   ; 36 | $24 | __run_135_x1
		.BYTE	24   ; 37 | $25 | __run_135_x2
		.BYTE	24   ; 38 | $26 | _walk1 (?)
		.BYTE	24   ; 39 | $27 | _walk2 (?)

		.BYTE	24   ; 40 | $28 | _walk3 (?)
		.BYTE	24   ; 41 | $29 | _walk4 (?)
		.BYTE	24   ; 42 | $2A | _walk5 (?)
		.BYTE	24   ; 43 | $2B | _get_hit (waterfall)
		.BYTE	24   ; 44 | $2C	|  bubble breath
